...
namespace joomkit\mapitapi2entry\widgets;

use joomkit\mapitapi2entry\MapitApi2entry;
use joomkit\mapitapi2entry\assetbundles\mapitapi2entrywidgetwidget\MapitApi2entryWidgetWidgetAsset;

use Craft;
use craft\base\Widget;

/**
 * mapitApi2entry Widget
 *
 ...
 * @since     1.0.0
 */
class MapitApi2entryWidget extends Widget
{
    ...
    {
        return Craft::t('mapit-api2entry', 'MapitApi2entryWidget');
    }
    ...
    {
        return Craft::getAlias("@joomkit/mapitapi2entry/assetbundles/mapitapi2entrywidgetwidget/dist/img/MapitApi2entryWidget-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'mapit-api2entry/_components/widgets/MapitApi2entryWidget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(MapitApi2entryWidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'mapit-api2entry/_components/widgets/MapitApi2entryWidget_body',
            [
